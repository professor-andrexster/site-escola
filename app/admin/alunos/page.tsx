    ...
    <div>
      ...
      <div className="flex items-center justify-between mb-6 gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-1">Base de dados de alunos. Aqui você cria, edita, gerencia matrícula, CPF e dados pessoais. Alunos cadastrados aqui podem criar sua conta de acesso em /admin/cadastro.</p>
        </div>
        <Link
