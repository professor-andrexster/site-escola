  ...
  return (
    <form ref={formRef} onSubmit={handleSubmit} className="space-y-4">
      ...
      <button
        type="submit"
        disabled={isPending}
        className="w-full bg-escola-azul text-white py-2.5 px-4 rounded-lg text-sm font-semibold hover:bg-escola-azul-medio disabled:opacity-60 disabled:cursor-not-allowed transition-colors foco-painel"
      >
