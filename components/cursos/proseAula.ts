 ...
 * ------------------------------------------------------------------ tamanhos
 *
 * O corpo era 15px, subiu para 17px e, em 2026-09-21, para 19px: o dono
 * abriu as aulas e achou a letra pequena. Código foi de 15 para 17, tabela de
 * 16 para 18, títulos subiram 3 a 4px. Sobre o piso original: não é preferência: 16px é o padrão do
...
export const proseAula = [
  '[&_h2]:text-white [&_h2]:font-black [&_h2]:text-[26px] md:[&_h2]:text-[30px] [&_h2]:mt-8 [&_h2]:mb-3 [&_h2]:font-geom',
  '[&_h3]:text-white [&_h3]:font-bold [&_h3]:text-[21px] md:[&_h3]:text-[23px] [&_h3]:mt-6 [&_h3]:mb-2',
  '[&_p]:text-white/70 [&_p]:leading-relaxed [&_p]:mb-4 [&_p]:text-[19px]',
  '[&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-4 [&_ol]:list-decimal [&_ol]:pl-6 [&_ol]:mb-4',
  '[&_li]:text-white/70 [&_li]:mb-2 [&_li]:text-[19px]',
  '[&_strong]:text-white [&_em]:text-white/80',
  '[&_code]:font-jetbrains [&_code]:text-curso-ciano [&_code]:bg-white/5 [&_code]:px-1.5 [&_code]:py-0.5 [&_code]:rounded [&_code]:text-[17px]',
  ...
  '[&_pre]:bg-black/50 [&_pre]:border [&_pre]:border-white/10 [&_pre]:rounded-xl [&_pre]:p-4 [&_pre]:mb-4 [&_pre]:overflow-x-auto [&_pre]:text-white/80 [&_pre]:font-jetbrains [&_pre]:text-[16px] [&_pre]:leading-relaxed',
  ...
  '[&_table]:w-full [&_table]:my-5 [&_table]:border-collapse [&_table]:text-[18px]',
...
export const proseDesafio = [
  '[&_p]:text-white/70 [&_p]:text-[19px] [&_p]:leading-relaxed [&_p]:mb-3',
  '[&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5',
  '[&_li]:text-white/70 [&_li]:text-[19px] [&_li]:mb-1.5',
  '[&_strong]:text-white',
  '[&_code]:font-jetbrains [&_code]:text-curso-ciano [&_code]:text-[17px]',
  '[&_pre]:bg-black/50 [&_pre]:rounded-lg [&_pre]:p-3 [&_pre]:mb-3 [&_pre]:overflow-x-auto [&_pre]:text-[16px] [&_pre]:text-white/80 [&_pre]:font-jetbrains',
  'text-white/70 text-[19px] leading-relaxed',
].join(' ')
