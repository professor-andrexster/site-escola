...
const ACAO_LABELS: Record<string, { label: string; cor: string }> = {
  ...
  login_falha: { label: 'Login falhou', cor: 'bg-amber-100 text-amber-700' },
  senha_redefinida_cpf: { label: 'Senha redefinida (CPF)', cor: 'bg-blue-100 text-blue-700' },
  senha_redefinida_admin: { label: 'Senha redefinida (gestão)', cor: 'bg-blue-100 text-blue-700' },
